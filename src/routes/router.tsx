...
export const router = createBrowserRouter(
  ...
  {
    // BASE_URL reflete o "base" do vite.config.ts — "/" localmente, "/sigave/"
    // no build para GitHub Pages (ver .github/workflows/deploy.yml). Sem
    // isso, links absolutos como "/dashboard" apontariam para
    // usuario.github.io/dashboard em vez de usuario.github.io/sigave/dashboard.
